...
public class Year_2023 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year2023);

        //Gradient
        NestedScrollView nestedScrollView = findViewById(R.id.year2023);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.year2023);
        ...
        tx1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Search_activity.class));
            }
        });
        ...
        Picasso.get().load("https://s6.uupload.ir/files/sm-a546ezkaafa-2_3oqc.jpg").placeholder(R.drawable.phone).into(circleImageView3);

        CircleImageView circleImageView4 = (CircleImageView) findViewById(R.id.fciv4);
        Picasso.get().load("https://s6.uupload.ir/files/sm-a346ezsaafa-2_yu5k.jpg").placeholder(R.drawable.phone).into(circleImageView4);

        CircleImageView circleImageView5 = (CircleImageView) findViewById(R.id.fciv5);
        Picasso.get().load("https://s6.uupload.ir/files/sm-s918bzgcafa-2_avwv.jpg").placeholder(R.drawable.phone).into(circleImageView5);

        CircleImageView circleImageView6 = (CircleImageView) findViewById(R.id.fciv6);
        Picasso.get().load("https://s6.uupload.ir/files/sm-s911bzkcafa-1_axff.jpg").placeholder(R.drawable.phone).into(circleImageView6);

        CircleImageView circleImageView7 = (CircleImageView) findViewById(R.id.fciv7);
        Picasso.get().load("https://s6.uupload.ir/files/s23-cotton-600x600_tax8.jpg").placeholder(R.drawable.phone).into(circleImageView7);
        ...
        civ1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_zfold5.class));
            }
        });
        ...
        civ2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_zflip5.class));
            }
        });
        ...
        civ3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_a54.class));
            }
        });
        ...
        civ4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_a34.class));
            }
        });
        ...
        civ5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_s23ultra.class));
            }
        });
        ...
        civ6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_s23plus.class));
            }
        });
        ...
        civ7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Year_2023.this , Ph_s23.class));
            }
        });
