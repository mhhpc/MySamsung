...
import com.mhh.mysamsung.phones_detail.check.galaxy_z.Ph_zflip5_check;
...
import com.mhh.mysamsung.phones_detail.full.galaxy_z.Ph_zflip5_full;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_a.Ph_a34_picture;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_z.Ph_zflip5_picture;
...
public class Ph_zflip5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_zflip5));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_zflip5_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_zflip5_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_zflip5_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_zflip5_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_zflip5_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_zflip5_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_zflip5_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_zflip5_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_zfold5));

        sg2 = findViewById(R.id.tx11);
        sg2.setText(getResources().getString(R.string.phones_zflip4));

        sg3 = findViewById(R.id.tx12);
        sg3.setText(getResources().getString(R.string.phones_zflip3));
        ...
        Picasso.get().load("https://s6.uupload.ir/files/sm-f731blgaafa-2_fbap.jpg").placeholder(R.drawable.phone).into(circleImageView);

        //suggest onclick
        @SuppressLint("CutPasteId") TextView sg1 = (TextView) findViewById(R.id.tx10);
        sg1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zfold5.class));
            }
        });
        ...
        sg2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zflip4.class));
            }
        });
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zflip5_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zflip5_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zflip5_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zflip5_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_zflip5_compare.class));
            }
        });
