...
public class Ph_tab_s8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_tab_s8);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_tabs8);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_tabs8);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/92068379032934_6iho.jpg");
