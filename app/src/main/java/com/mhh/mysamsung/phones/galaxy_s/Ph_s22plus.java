...
public class Ph_s22plus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_s22plus);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22plus);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22plus);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/s22_5w1i.jpg");
