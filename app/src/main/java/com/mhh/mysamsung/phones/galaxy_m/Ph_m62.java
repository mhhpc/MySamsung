...
public class Ph_m62 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_m62);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_m62);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_m62);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/d619a06ecaea458e8e420bfe9a09096a7b3405dd_1630841890_f6ly.jpg");

        //button onclick
        @SuppressLint("CutPasteId") Button ph1 = (Button) findViewById(R.id.b1);
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_m62.this , Ph_m62_full.class));
            }
        });
