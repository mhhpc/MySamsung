...
public class Ph_j6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_j6);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_j6);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_j6);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/گوشی-موبایل-سامسونگ-مدل-galaxy-j6-دو-سیم-کارت-ظرفیت-32-گیگابایت_hfqq.jpg");
