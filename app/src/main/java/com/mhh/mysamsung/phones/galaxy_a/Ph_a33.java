...
public class Ph_a33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_a33);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_a33);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_a33);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/4182117_5uiw.jpg");
