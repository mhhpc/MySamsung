...
import com.mhh.mysamsung.phones_detail.check.galaxy_a.Ph_a33_check;
...
import com.mhh.mysamsung.phones_detail.pictures.galaxy_a.Ph_a33_picture;
...
public class Ph_a33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_a33));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_a33_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_a33_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_a33_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_a33_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_a33_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_a33_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_a33_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_a33_battery2));
        ...
        sg3.setText(getResources().getString(R.string.phones_a52s));
        ...
        Picasso.get().load("https://s6.uupload.ir/files/4182117_5uiw.jpg").placeholder(R.drawable.phone).into(circleImageView);
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a33.this , Ph_a33_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a33.this , Ph_a33_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a33.this , Ph_a33_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a33.this , Ph_a33_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a33.this , Ph_a33_compare.class));
            }
        });
