...
import com.mhh.mysamsung.phones_detail.check.galaxy_s.Ph_s23ultra_check;
...
import com.mhh.mysamsung.phones_detail.full.galaxy_s.Ph_s23ultra_full;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_a.Ph_a34_picture;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_s.Ph_s23ultra_picture;
...
public class Ph_s23ultra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_s23ultra));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_s23ultra_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_s23ultra_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_s23ultra_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_s23ultra_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_s23ultra_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_s23ultra_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_s23ultra_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_s23ultra_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_s23plus));
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23ultra_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23ultra_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23ultra_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23ultra_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23ultra_compare.class));
            }
        });
