package com.mhh.mysamsung.phones.galaxy_note;
...
import com.mhh.mysamsung.phones_detail.check.galaxy_note.Ph_note20ultra_check;
import com.mhh.mysamsung.phones_detail.compare.galaxy_note.Ph_note20ultra_compare;
import com.mhh.mysamsung.phones_detail.customize.galaxy_note.Ph_note20ultra_customize;
import com.mhh.mysamsung.phones_detail.full.galaxy_note.Ph_note20ultra_full;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_note.Ph_note20ultra_picture;
...
public class Ph_note20ultra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_note20ultra));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_note20ultra_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_note20ultra_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_note20ultra_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_note20ultra_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_note20ultra_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_note20ultra_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_note20ultra_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_note20ultra_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_s22ultra));

        sg2 = findViewById(R.id.tx11);
        sg2.setText(getResources().getString(R.string.phones_zfold4));

        sg3 = findViewById(R.id.tx12);
        sg3.setText(getResources().getString(R.string.phones_note20));
        ...
        sg3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_note20.class));
            }
        });
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20ultra.this , Ph_note20ultra_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20ultra.this , Ph_note20ultra_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20ultra.this , Ph_note20ultra_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20ultra.this , Ph_note20ultra_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20ultra.this , Ph_note20ultra_compare.class));
            }
        });
