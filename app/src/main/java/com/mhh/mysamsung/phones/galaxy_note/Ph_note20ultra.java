...
public class Ph_note20ultra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_note20ultra);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20ultra);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20ultra);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/1_ip3a.jpg");
