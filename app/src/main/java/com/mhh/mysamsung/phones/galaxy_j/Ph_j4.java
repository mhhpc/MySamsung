...
public class Ph_j4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_j4);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_j4);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_j4);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/samsung-galaxy-j4_0h1f.jpg");
