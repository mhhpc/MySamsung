...
public class Ph_m33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_m33);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_m33);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_m33);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/619293036__0wt2.jpg");
