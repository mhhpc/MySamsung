...
public class Ph_zfold3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_zfold3);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zfold3);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zfold3);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/samsung-galaxy-z-fold-3-s-pen_38vd.jpg");
