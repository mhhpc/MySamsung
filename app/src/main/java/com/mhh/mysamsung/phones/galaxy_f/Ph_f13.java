...
import com.mhh.mysamsung.phones_detail.full.galaxy_f.Ph_f13_full;
...
public class Ph_f13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_f13));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_f13_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_f13_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_f13_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_f13_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_f13_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_f13_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_f13_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_f13_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_f23));

        sg2 = findViewById(R.id.tx11);
        sg2.setText(getResources().getString(R.string.phones_f42));
        ...
        Picasso.get().load("https://s6.uupload.ir/files/samsung-galaxy-f13-1_sk5q.jpg").placeholder(R.drawable.phone).into(circleImageView);

        //suggest onclick
        @SuppressLint("CutPasteId") TextView sg1 = (TextView) findViewById(R.id.tx10);
        sg1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_f23.class));
            }
        });
