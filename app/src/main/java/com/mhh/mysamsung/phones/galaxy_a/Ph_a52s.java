...
import com.mhh.mysamsung.phones_detail.full.galaxy_s.galaxy_a.Ph_a52s_full;
...
public class Ph_a52s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_a52s);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_a52s);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_a52s);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/4_zu_3_samsung_galaxy_a52s_8zjy.jpg");
