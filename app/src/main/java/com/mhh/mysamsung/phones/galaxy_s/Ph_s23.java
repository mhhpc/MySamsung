...
import com.mhh.mysamsung.phones_detail.check.galaxy_s.Ph_s23_check;
...
import com.mhh.mysamsung.phones_detail.full.galaxy_s.Ph_s23_full;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_a.Ph_a34_picture;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_s.Ph_s23_picture;
...
public class Ph_s23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_s23));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_s23_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_s23_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_s23_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_s23_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_s23_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_s23_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_s23_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_s23_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_s23ultra));

        sg2 = findViewById(R.id.tx11);
        sg2.setText(getResources().getString(R.string.phones_s23plus));

        sg3 = findViewById(R.id.tx12);
        sg3.setText(getResources().getString(R.string.phones_s22));
        ...
        Picasso.get().load("https://s6.uupload.ir/files/s23-cotton-600x600_tax8.jpg").placeholder(R.drawable.phone).into(circleImageView);
        ...
        sg2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23plus.class));
            }
        });
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_s23_compare.class));
            }
        });
