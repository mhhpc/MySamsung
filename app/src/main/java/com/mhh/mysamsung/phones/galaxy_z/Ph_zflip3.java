...
import com.mhh.mysamsung.phones_detail.check.galaxy_z.Ph_zflip3_check;
...
import com.mhh.mysamsung.phones_detail.full.galaxy_z.Ph_zflip3_full;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_z.Ph_zflip3_picture;
...
public class Ph_zflip3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_zflip3));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_zflip3_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_zflip3_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_zflip3_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_zflip3_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_zflip3_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_zflip3_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_zflip3_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_zflip3_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_zflip4));

        sg2 = findViewById(R.id.tx11);
        sg2.setText(getResources().getString(R.string.phones_s22ultra));
        ...
        Picasso.get().load("https://s6.uupload.ir/files/zflip3_carousel_foldunfoldcombo_phantomblack_mo_tugg.jpg").placeholder(R.drawable.phone).into(circleImageView);
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zflip3.this , Ph_zflip3_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zflip3.this , Ph_zflip3_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zflip3.this , Ph_zflip3_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zflip3.this , Ph_zflip3_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zflip3.this , Ph_zflip3_compare.class));
            }
        });
