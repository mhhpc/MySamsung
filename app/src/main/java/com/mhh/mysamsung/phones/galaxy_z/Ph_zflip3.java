...
public class Ph_zflip3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_zflip3);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zflip3);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zflip3);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/zflip3_carousel_foldunfoldcombo_phantomblack_mo_tugg.jpg");
