...
import com.mhh.mysamsung.phones_detail.full.galaxy_s.galaxy_a.Ph_a73_full;
...
public class Ph_a73 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_a73);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_a73);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_a73);
