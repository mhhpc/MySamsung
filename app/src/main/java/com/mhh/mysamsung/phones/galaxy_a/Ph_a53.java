...
import com.mhh.mysamsung.phones_detail.full.galaxy_s.galaxy_a.Ph_a53_full;
...
public class Ph_a53 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_a53);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_a53);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_a53);
        ...
        new DownloadImageTask(circleImageView).execute("https://s6.uupload.ir/files/182332_2020_7zu6.jpg");
