package com.mhh.mysamsung.phones.galaxy_a;
...
import com.mhh.mysamsung.phones_detail.check.galaxy_a.Ph_a53_check;
...
import com.mhh.mysamsung.phones_detail.full.galaxy_a.Ph_a53_full;
import com.mhh.mysamsung.phones_detail.pictures.galaxy_a.Ph_a53_picture;
...
public class Ph_a53 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.phones_a53));

        tv1 = findViewById(R.id.tv1);
        tv1.setText(getResources().getString(R.string.ph_a53_screen1));

        tvv1 = findViewById(R.id.tvv1);
        tvv1.setText(getResources().getString(R.string.ph_a53_screen2));

        tv2 = findViewById(R.id.tv2);
        tv2.setText(getResources().getString(R.string.ph_a53_hardware1));

        tvv2 = findViewById(R.id.tvv2);
        tvv2.setText(getResources().getString(R.string.ph_a53_hardware2));

        tv3 = findViewById(R.id.tv3);
        tv3.setText(getResources().getString(R.string.ph_a53_camera1));

        tvv3 = findViewById(R.id.tvv3);
        tvv3.setText(getResources().getString(R.string.ph_a53_camera2));

        tv4 = findViewById(R.id.tv4);
        tv4.setText(getResources().getString(R.string.ph_a53_battery1));

        tvv4 = findViewById(R.id.tvv4);
        tvv4.setText(getResources().getString(R.string.ph_a53_battery2));

        sg1 = findViewById(R.id.tx10);
        sg1.setText(getResources().getString(R.string.phones_a73));

        sg2 = findViewById(R.id.tx11);
        sg2.setText(getResources().getString(R.string.phones_a52s));

        sg3 = findViewById(R.id.tx12);
        sg3.setText(getResources().getString(R.string.phones_a33));
        ...
        Picasso.get().load("https://s6.uupload.ir/files/182332_2020_7zu6.jpg").placeholder(R.drawable.phone).into(circleImageView);
        ...
        sg2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_a52s.class));
            }
        });
        ...
        sg3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext() , Ph_a33.class));
            }
        });
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a53.this , Ph_a53_full.class));
            }
        });
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a53.this , Ph_a53_check.class));
            }
        });
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a53.this , Ph_a53_picture.class));
            }
        });
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a53.this , Ph_a53_customize.class));
            }
        });
        ...
        ph5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_a53.this , Ph_a53_compare.class));
            }
        });
