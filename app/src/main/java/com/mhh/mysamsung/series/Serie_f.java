...
public class Serie_f extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Gradient -----------
        NestedScrollView nestedScrollView = findViewById(R.id.serie_f);
        ...
        Picasso.get().load("https://s6.uupload.ir/files/samsunggalaxyf42_0bfy.jpg").placeholder(R.drawable.phone).into(circleImageView2);
