...
public class Tips_f_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tips_factivity);

        //Gradient -----------
        NestedScrollView nestedScrollView = findViewById(R.id.tips_f);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.tips_f);
