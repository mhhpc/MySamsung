...
public class Tips_note_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tips_note);

        //Gradient -----------
        NestedScrollView nestedScrollView = findViewById(R.id.tips_note);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.tips_note);
