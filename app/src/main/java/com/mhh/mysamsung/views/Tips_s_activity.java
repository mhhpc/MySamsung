...
public class Tips_s_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tips_sactivity);

        //Gradient -----------
        NestedScrollView nestedScrollView = findViewById(R.id.tips_s);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.tips_s);
