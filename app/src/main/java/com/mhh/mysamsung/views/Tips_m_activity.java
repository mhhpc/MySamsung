...
public class Tips_m_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tips_mactivity);

        //Gradient -----------
        NestedScrollView nestedScrollView = findViewById(R.id.tips_m);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.tips_m);
