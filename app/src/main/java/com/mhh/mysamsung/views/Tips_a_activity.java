...
public class Tips_a_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tips_aactivity);

        //Gradient -----------
        NestedScrollView nestedScrollView = findViewById(R.id.tips_a);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.tips_a);
