...
public class Ph_s23plus_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s23plus_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s23plus_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s23plus_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_s23plus_customize.this , Guide_background.class));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://drive.google.com/drive/folders/1oLrZlpotqib0cS1KPJ14DZg9WD7SIXhy"));
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://uupload.ir/view/galaxy_bells_grgp.mp3/");
            }
        });
        ...
        Picasso.get().load("https://s6.uupload.ir/files/samsung-galaxy-s23-wallpapers-768x488_mkqp.jpg").into(imageView3);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s23plus_customize.this, Webview_activity.class);
