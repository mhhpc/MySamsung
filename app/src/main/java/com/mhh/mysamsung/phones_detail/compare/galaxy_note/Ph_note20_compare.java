...
public class Ph_note20_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note20_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20_compare);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-s23/samsung-galaxy-note20/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?&idPhone1=12082&idPhone2=10338");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_note20_compare.this, Webview_activity.class);
