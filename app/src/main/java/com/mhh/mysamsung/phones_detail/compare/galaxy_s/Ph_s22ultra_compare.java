...
public class Ph_s22ultra_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22ultra_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22ultra_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22ultra_compare);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/compare/?product1=sm-s906bzwcmea&product2=sm-s901bzwcmea&product3=sm-s908bdrcmea");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-s22-plus/samsung-galaxy-s22-ultra/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?idPhone1=11252&idPhone2=11251");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22ultra_compare.this, Webview_activity.class);
