...
public class Ph_zfold3_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zfold3_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zfold3_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zfold3_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zfold3_customize.this , Guide_background.class));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://drive.google.com/drive/folders/1C7Zkv9rhSD6zca8kEZq_9bxkld9cv8tF"));
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://drive.google.com/drive/folders/12M2g-WzGeB6u7Igv_3P0ugbXrq7EH-bw"));
                startActivity(intentRate);
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_zfold3_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا مطابق راهنما عمل کنید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_zfold3_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا از تنظیمات گوشی تغییر دهید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        Picasso.get().load("https://s8.uupload.ir/files/wp9665827_qog8.jpg").into(imageView3);

        ImageView imageView4 = (ImageView) findViewById(R.id.image1_1);
        Picasso.get().load("https://s8.uupload.ir/files/wp9665827_qog8.jpg").into(imageView4);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zfold3_customize.this, Webview_activity.class);
