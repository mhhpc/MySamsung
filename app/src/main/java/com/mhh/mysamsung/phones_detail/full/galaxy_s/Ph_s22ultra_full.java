...
public class Ph_s22ultra_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22ultra_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22ultra_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22ultra_full);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-s22-ultra/specs/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-s22-ultra/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s22_ultra_5g-11251.php");
            }
        });
        ...
        new DownloadImageTask(imageView2).execute("https://s6.uupload.ir/files/csm_untitled_2_7_432bb95979(1)_0m0d.jpg");
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22ultra_full.this, Webview_activity.class);
