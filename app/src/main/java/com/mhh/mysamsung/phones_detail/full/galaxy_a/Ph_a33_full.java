...
public class Ph_a33_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_a33_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_a33_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_a33_full);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-a/galaxy-a33-5g-awesome-black-128gb-sm-a336ezkgmea/#specs");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-a33-5g/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_a33_5g-11429.php");
            }
        });
        ...
        new DownloadImageTask(imageView2).execute("https://s6.uupload.ir/files/4182117_5uiw.jpg");
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_a33_full.this, Webview_activity.class);
