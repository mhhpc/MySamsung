package com.mhh.mysamsung.phones_detail.compare.galaxy_s;
...
public class Ph_s23plus_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s23plus_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s23plus_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s23plus_compare);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.samsung.com/iran/smartphones/galaxy-s23-ultra/compare/"));
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.zoomit.ir/product/compare/mobile/?products=samsung-galaxy-s23%2Csamsung-galaxy-s22%2Csamsung-galaxy-s22-plus"));
                startActivity(intentRate);
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.gsmarena.com/compare.php3?idPhone1=12082&idPhone2=12083&idPhone3=11252"));
                startActivity(intentRate);
            }
        });
