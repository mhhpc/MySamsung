...
public class Ph_zfold3_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zfold3_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zfold3_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zfold3_full);
