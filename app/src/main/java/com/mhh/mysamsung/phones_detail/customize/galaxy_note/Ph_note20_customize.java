...
public class Ph_note20_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note20_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20_customize.this , Guide_background.class));
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_note20_customize.this, Webview_activity.class);
