...
public class Ph_s22_full extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-s22/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s22_5g-11253.php");
            }
        });
        ...
        new DownloadImageTask(imageView2).execute("https://s6.uupload.ir/files/311440-469190-medium_dcmu.jpg");
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22_full.this, Webview_activity.class);
