...
public class Ph_zflip4_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zflip4_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zflip4_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zflip4_check);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-z-flip4/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/mobile-review/385839-galaxy-z-flip4-review/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_z_flip4-review-2467.php");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zflip4_check.this, Webview_activity.class);
