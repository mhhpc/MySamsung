...
public class Ph_s22ultra_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22ultra_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22ultra_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22ultra_check);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-s22-ultra/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/mobile-review/379469-samsung-galaxy-s22-ultra-review/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s22_ultra-review-2382.php");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22ultra_check.this, Webview_activity.class);
