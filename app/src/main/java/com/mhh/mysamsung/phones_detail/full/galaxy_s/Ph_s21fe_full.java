...
public class Ph_s21fe_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s21fe_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s21fe_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s21fe_full);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-s21-5g/specs/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-s21-fe-5g/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s21_fe_5g-10954.php");
            }
        });
        ...
        new DownloadImageTask(imageView2).execute("https://s6.uupload.ir/files/celular-smartphone-samsung-galaxy-s21fe-tela-6-128gb-e-5g_660422_1_9r36.jpg");
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s21fe_full.this, Webview_activity.class);
