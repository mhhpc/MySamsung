package com.mhh.mysamsung.phones_detail.check.galaxy_s;
...
public class Ph_s23plus_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s23plus_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s23plus_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s23plus_check);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.samsung.com/iran/smartphones/galaxy-s23/"));
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.zoomit.ir/mobile-review/404057-samsung-galaxy-s23-plus-review/"));
                startActivity(intentRate);
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.gsmarena.com/samsung_galaxy_s23_plus-review-2527.php"));
                startActivity(intentRate);
            }
        });
