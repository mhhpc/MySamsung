...
public class Ph_s22_picture extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22_picture);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22_picture);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22_picture);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-s22/showroom/#see-in-360");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s22_5g-pictures-11253.php");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-s22/photos/");
            }
        });
        ...
        Picasso.get().load("https://s8.uupload.ir/files/samsung-galaxy-s22-5g-2_nnnm.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView3);

        ImageView imageView4 = (ImageView) findViewById(R.id.imv2);
        Picasso.get().load("https://s8.uupload.ir/files/001_galaxys22_online-colors_lzk3.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView4);

        ImageView imageView5 = (ImageView) findViewById(R.id.imv3);
        Picasso.get().load("https://s8.uupload.ir/files/s22plus_exclusive_carousel_skyblue_productkv_mo_w_ocopy_u8c.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView5);

        ImageView imageView6 = (ImageView) findViewById(R.id.imv4);
        Picasso.get().load("https://s8.uupload.ir/files/s22_borapurple_carousel_productkv_mo(1)_ehzi.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView6);

        ImageView imageView7 = (ImageView) findViewById(R.id.imv5);
        Picasso.get().load("https://s8.uupload.ir/files/flrc-214-r0-skyblue-01-pdp-gallery-1600x1200_pc27.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView7);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22_picture.this, Webview_activity.class);
