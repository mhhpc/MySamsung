...
public class Ph_s22ultra_customize extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_s22ultra_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22ultra_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22ultra_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_s22ultra_customize.this , Guide_background.class));
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_s22ultra_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا مطابق راهنما عمل کنید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_s22ultra_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا از تنظیمات گوشی تغییر دهید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        Picasso.get().load("https://s8.uupload.ir/files/samsung-galaxy-s22-wallpaper-dex-04_m9vf.jpg").into(imageView3);

        ImageView imageView4 = (ImageView) findViewById(R.id.image1_1);
        Picasso.get().load("https://s8.uupload.ir/files/samsung-galaxy-s22-wallpaper-dex-04_m9vf.jpg").into(imageView4);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22ultra_customize.this, Webview_activity.class);
