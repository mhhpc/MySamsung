...
public class Ph_zflip4_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zflip4_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zflip4_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zflip4_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_zflip4_customize.this , Guide_background.class));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://drive.google.com/drive/folders/11SEL0oGTvwswd3qjctyGSbBHxBw_bqB8"));
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://drive.google.com/drive/folders/1Vo-8FNq7fJvfjY-O6HNzsgPPaGbwPGMc"));
                startActivity(intentRate);
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_zflip4_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا مطابق راهنما عمل کنید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_zflip4_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا از تنظیمات گوشی تغییر دهید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        Picasso.get().load("https://s8.uupload.ir/files/samsung-galaxy-z-flip-4-wallpapers-featured_x9k4.jpg").into(imageView3);

        ImageView imageView4 = (ImageView) findViewById(R.id.image1_1);
        Picasso.get().load("https://s8.uupload.ir/files/samsung-galaxy-z-flip-4-wallpapers-featured_x9k4.jpg").into(imageView4);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zflip4_customize.this, Webview_activity.class);
