...
public class Ph_s23ultra_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s23ultra_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s23ultra_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s23ultra_full);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.samsung.com/iran/smartphones/galaxy-s23-ultra/"));
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.zoomit.ir/mobile-review/402267-samsung-galaxy-s23-ultra-review/"));
                startActivity(intentRate);
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.gsmarena.com/samsung_galaxy_s23_ultra-review-2526.php"));
                startActivity(intentRate);
            }
        });
        ...
        Picasso.get().load("https://s6.uupload.ir/files/sm-s918bzgcafa-2_avwv.jpg").into(imageView2);
