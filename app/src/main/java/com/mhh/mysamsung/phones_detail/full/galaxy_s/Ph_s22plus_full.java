...
public class Ph_s22plus_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22plus_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22plus_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22plus_full);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-s22/specs/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-s22-plus/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s22+_5g-11252.php");
            }
        });
        ...
        new DownloadImageTask(imageView2).execute("https://s6.uupload.ir/files/s22_5w1i.jpg");
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22plus_full.this, Webview_activity.class);
