...
public class Ph_zflip3_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zflip3_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zflip3_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zflip3_check);
