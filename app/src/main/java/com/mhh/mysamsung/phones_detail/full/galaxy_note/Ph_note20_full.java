...
public class Ph_note20_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note20_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20_full);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-note20/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_note20-10338.php");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_note20_full.this, Webview_activity.class);
