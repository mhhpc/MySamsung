...
public class Ph_s22_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_s22_customize.this , Guide_background.class));
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_s22_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا مطابق راهنما عمل کنید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Ph_s22_customize.this, "گوشی شما از این قابلیت پشتیبانی نمی\u200Cکند. لطفا از تنظیمات گوشی تغییر دهید.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22_customize.this, Webview_activity.class);
