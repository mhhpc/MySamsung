...
public class Ph_s22_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22_compare);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-s22-plus/samsung-galaxy-s22/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?idPhone1=11252&idPhone2=11253");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22_compare.this, Webview_activity.class);
