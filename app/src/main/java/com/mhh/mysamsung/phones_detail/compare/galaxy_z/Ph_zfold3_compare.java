...
public class Ph_zfold3_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zfold3_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zfold3_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zfold3_compare);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/compare/?product1=sm-f926bzkdmea&product2=sm-f711bzeamea&product3=sm-s908bdrcmea");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-z-fold3/samsung-galaxy-z-flip-3/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?idPhone1=10906&idPhone2=11044");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zfold3_compare.this, Webview_activity.class);
