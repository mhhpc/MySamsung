package com.mhh.mysamsung.phones_detail.full.galaxy_note;
...
public class Ph_note20ultra_full extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note20ultra_full);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20ultra_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20ultra_full);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.zoomit.ir/product/samsung-galaxy-note20-ultra/"));
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.gsmarena.com/samsung_galaxy_note20_ultra_5g-10261.php"));
                startActivity(intentRate);
            }
        });
