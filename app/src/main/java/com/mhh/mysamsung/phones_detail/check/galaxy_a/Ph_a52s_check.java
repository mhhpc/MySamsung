package com.mhh.mysamsung.phones_detail.check.galaxy_a;
...
public class Ph_a52s_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_a52s_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_a52s_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_a52s_check);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/uk/smartphones/galaxy-a/galaxy-a52s-5g-awesomeviolet-128gb-sm-a528blvceua/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/mobile-review/376103-galaxy-a52s-5g-review/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_a52s_5g-review-2323.php");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_a52s_check.this, Webview_activity.class);
