...
public class Ph_s22plus_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22plus_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22plus_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22plus_compare);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22plus_compare.this, Webview_activity.class);
