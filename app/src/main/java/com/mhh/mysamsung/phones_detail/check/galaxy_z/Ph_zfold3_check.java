    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.samsung.com/iran/smartphones/galaxy-z-fold3-5g/"));
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.zoomit.ir/mobile-review/374007-samsung-galaxy-z-fold-3-review/"));
                startActivity(intentRate);
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.gsmarena.com/samsung_galaxy_z_fold3_5g-review-2303.php"));
                startActivity(intentRate);
            }
        });
