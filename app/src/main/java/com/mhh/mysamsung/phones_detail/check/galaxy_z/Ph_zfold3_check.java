...
public class Ph_zfold3_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zfold3_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zfold3_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zfold3_check);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-z-fold3-5g/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/mobile-review/374007-samsung-galaxy-z-fold-3-review/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_z_fold3_5g-review-2303.php");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zfold3_check.this, Webview_activity.class);
