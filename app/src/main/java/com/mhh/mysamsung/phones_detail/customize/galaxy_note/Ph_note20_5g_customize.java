...
public class Ph_note20_5g_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note205g_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20_5g_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20_5g_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20_5g_customize.this , Guide_background.class));
            }
        });
        ...
        Picasso.get().load("https://s6.uupload.ir/files/samsung-galaxy-note-20-wallpaper-4_m4o.jpg").into(imageView3);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_note20_5g_customize.this, Webview_activity.class);
