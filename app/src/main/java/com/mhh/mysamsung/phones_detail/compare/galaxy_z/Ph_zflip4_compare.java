...
public class Ph_zflip4_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_zflip4_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zflip4_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zflip4_compare);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/compare/?product1=sm-f721blvamea&product2=sm-f711bzeamea&product3=sm-s918bzgqmea");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-z-flip-4/samsung-galaxy-z-flip-3/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?idPhone1=11538&idPhone2=11044");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zflip4_compare.this, Webview_activity.class);
