...
public class Ph_s23plus_picture extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s23plus_picture);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s23plus_picture);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s23plus_picture);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.gsmarena.com/samsung_galaxy_s23+-pictures-12083.php"));
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.zoomit.ir/product/samsung-galaxy-s23-plus/?g=104883&slide=5"));
                startActivity(intentRate);
            }
        });
        ...
        Picasso.get().load("https://s6.uupload.ir/files/sm-s911bzkcafa-1_axff.jpg").into(imageView2);

        ImageView imageView3 = (ImageView) findViewById(R.id.imv1);
        Picasso.get().load("https://s6.uupload.ir/files/galaxy-s23-highlights-exclusive-kv(1)_v3ss.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView3);

        ImageView imageView4 = (ImageView) findViewById(R.id.imv2);
        Picasso.get().load("https://s6.uupload.ir/files/product_color_lavender_z9v9.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView4);

        ImageView imageView5 = (ImageView) findViewById(R.id.imv3);
        Picasso.get().load("https://s6.uupload.ir/files/galaxy-s23-highlights-color-back-green_bpg2.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView5);

        ImageView imageView6 = (ImageView) findViewById(R.id.imv4);
        Picasso.get().load("https://s6.uupload.ir/files/samsung-galaxy-s23-plus-5g-2_5xx.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView6);

        ImageView imageView7 = (ImageView) findViewById(R.id.imv5);
        Picasso.get().load("https://s6.uupload.ir/files/samsung-galaxy-s23-plus-5g-4_qyuq.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView7);
