...
public class Ph_s22plus_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22plus_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22plus_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22plus_check);
