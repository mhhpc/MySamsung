...
public class Ph_zflip4_full extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_zflip4_full);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_zflip4_full);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/galaxy-z-flip4/specs/");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/samsung-galaxy-z-flip-4/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_z_flip4-11538.php");
            }
        });
        ...
        new DownloadImageTask(imageView2).execute("https://s6.uupload.ir/files/042f6098-82f6-439e-8d61-176a99ddcaff_qb74.jpg");
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zflip4_full.this, Webview_activity.class);
