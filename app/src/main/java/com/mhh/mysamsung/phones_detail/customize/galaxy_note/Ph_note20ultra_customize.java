package com.mhh.mysamsung.phones_detail.customize.galaxy_note;
...
public class Ph_note20ultra_customize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note20ultra_customize);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20ultra_customize);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20ultra_customize);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Ph_note20ultra_customize.this , Guide_background.class));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://drive.google.com/drive/folders/1EZkeswwP2dUsTSAy3JaH8HiBhRNHJK9s"));
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://uupload.ir/view/over_the_horizon_s20_ringtone_ks5r.mp3/");
            }
        });
        ...
        Picasso.get().load("https://s6.uupload.ir/files/samsung-galaxy-note-20-ultra-violet-purple-teal-turquoise-1024x768-2324_rhs.jpg").into(imageView3);
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_note20ultra_customize.this, Webview_activity.class);
