...
public class Ph_zflip3_compare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.samsung.com/iran/smartphones/compare/?product1=sm-f711bzeamea&product2=sm-f721blvamea&product3=sm-s908bdrcmea");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-z-flip-3/samsung-galaxy-z-flip-4/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?&idPhone2=11044&idPhone1=11538");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_zflip3_compare.this, Webview_activity.class);
