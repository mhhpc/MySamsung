...
public class Ph_s22_check extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_s22_check);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_s22_check);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_s22_check);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/samsung_galaxy_s22-review-2396.php");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_s22_check.this, Webview_activity.class);
