    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intentRate.setData(Uri.parse("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-note20-5g/samsung-galaxy-s23/"));
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intentRate = new Intent(Intent.ACTION_VIEW);
                intentRate.setData(Uri.parse("https://www.gsmarena.com/compare.php3?&idPhone2=10325&idPhone1=12082"));
                startActivity(intentRate);
            }
        });
