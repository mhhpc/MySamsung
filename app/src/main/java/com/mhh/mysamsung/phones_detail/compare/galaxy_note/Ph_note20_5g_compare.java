...
public class Ph_note20_5g_compare extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ph_note205g_compare);

        //Gradient -----------
        ConstraintLayout constraintLayout = findViewById(R.id.ph_note20_5g_compare);
        ...
        //Animation ------------
        final ViewGroup r = findViewById(R.id.ph_note20_5g_compare);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DomainName("https://www.zoomit.ir/product/compare/mobile/samsung-galaxy-note20-5g/samsung-galaxy-s23/");
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DomainName("https://www.gsmarena.com/compare.php3?&idPhone2=10325&idPhone1=12082");
            }
        });
    ...
    private void DomainName(String s) {
        ...
        Intent intent = new Intent(Ph_note20_5g_compare.this, Webview_activity.class);
